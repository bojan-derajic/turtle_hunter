...
static const _TurtleArray_type_support_symbol_names_t _TurtleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_hunter_interfaces, msg, TurtleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_hunter_interfaces, msg, TurtleArray)),
  }
};
...
{
  return &::turtle_hunter_interfaces::msg::rosidl_typesupport_cpp::TurtleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_hunter_interfaces, msg, TurtleArray)() {
  return get_message_type_support_handle<turtle_hunter_interfaces::msg::TurtleArray>();
}
