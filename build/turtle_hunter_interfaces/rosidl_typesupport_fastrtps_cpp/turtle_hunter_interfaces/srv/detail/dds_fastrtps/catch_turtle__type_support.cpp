...
#include "turtle_hunter_interfaces/srv/detail/catch_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_hunter_interfaces::srv::CatchTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_hunter_interfaces::srv::CatchTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const turtle_hunter_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_hunter_interfaces::srv::CatchTurtle_Request *>(
    untyped_ros_message);
...
{
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_hunter_interfaces, srv, CatchTurtle_Request)() {
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtle_hunter_interfaces
cdr_serialize(
  const turtle_hunter_interfaces::srv::CatchTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_hunter_interfaces::srv::CatchTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const turtle_hunter_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtle_hunter_interfaces::srv::CatchTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_hunter_interfaces, srv, CatchTurtle_Response)() {
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle_Response__handle;
}
...
{
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_hunter_interfaces, srv, CatchTurtle)() {
  return &turtle_hunter_interfaces::srv::typesupport_fastrtps_cpp::_CatchTurtle__handle;
}
