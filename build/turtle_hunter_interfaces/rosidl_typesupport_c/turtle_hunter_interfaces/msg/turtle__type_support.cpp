...
static const _Turtle_type_support_symbol_names_t _Turtle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_hunter_interfaces, msg, Turtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_hunter_interfaces, msg, Turtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_hunter_interfaces, msg, Turtle)() {
  return &::turtle_hunter_interfaces::msg::rosidl_typesupport_c::Turtle_message_type_support_handle;
}
