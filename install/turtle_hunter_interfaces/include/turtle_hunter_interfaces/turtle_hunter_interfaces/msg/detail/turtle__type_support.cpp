...
{
  new (message_memory) turtle_hunter_interfaces::msg::Turtle(_init);
}

void Turtle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_hunter_interfaces::msg::Turtle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Turtle_message_member_array[3] = {
  {
    ...
    offsetof(turtle_hunter_interfaces::msg::Turtle, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_hunter_interfaces::msg::Turtle, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_hunter_interfaces::msg::Turtle, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Turtle_message_members = {
  ...
  "Turtle",  // message name
  3,  // number of fields
  sizeof(turtle_hunter_interfaces::msg::Turtle),
...
{
  return &::turtle_hunter_interfaces::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_hunter_interfaces, msg, Turtle)() {
  return &::turtle_hunter_interfaces::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
